...
export function CursorMonitoringPanel() {
  ...
  const fetchCursorStatus = async () => {
    setLoading(true);
    try {
      const response = await fetch('https://mentions-backend.vercel.app/api/api/admin/cursor-status');
  ...
  const runHealthCheck = async () => {
    ...
    try {
      const response = await fetch('https://mentions-backend.vercel.app/api/api/admin/cursor-health-check?cleanup=true');
      const result = await response.json();
  ...
  const testCursorContinuity = async () => {
    setTesting(true);
    try {
      const response = await fetch('https://mentions-backend.vercel.app/api/api/admin/test-cursor-continuity', {
        method: 'POST',
