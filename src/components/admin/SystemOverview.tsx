...
export function SystemOverview({ onRefresh, loading }: SystemOverviewProps) {
  ...
  const fetchSystemData = async () => {
    try {
      // Fetch system health
      const healthResponse = await fetch('https://brandprotected.com/api/api/admin/system-health');
      ...
      // Fetch cache stats
      const cacheResponse = await fetch('https://brandprotected.com/api/api/admin/cache-stats');
      if (cacheResponse.ok) {
