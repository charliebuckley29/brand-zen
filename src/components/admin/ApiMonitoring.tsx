...
export function ApiMonitoring({ onRefresh, loading }: ApiMonitoringProps) {
  ...
  const fetchApiData = async () => {
    try {
      ...
      const limitsResponse = await fetch('https://mentions-backend.vercel.app/api/api/admin/api-limits');
      ...
      const quotaResponse = await fetch('https://mentions-backend.vercel.app/api/api/admin/user-quota-usage');
      if (quotaResponse.ok) {
