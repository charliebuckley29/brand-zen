...
-- Description: Aggressively removes SECURITY DEFINER from all views that don't need it
-- Priority: HIGH - Security compliance fix
...
-- This query should return no rows if all views are properly created without SECURITY DEFINER
